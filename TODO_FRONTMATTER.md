...
- sidebar_position: Based on _category_.json or file order
- sidebar_key: From parent _category_.json key field
...
2. read_file the parent _category_.json to get:
...
### category_.json reference format:
```json
{
  "label": "User Guide",
