...
<FeatureGrid
    ...
    items={[
        ...
        },
        {
            ...
            children: (
                <>
                    Generates default commit, tag, and changelog templates
                    that can be customized for your team's workflow.
                </>
            ),
        },
        {
        ...
        },
        {
            ...
            children: (
                <>
                    Generates example resources demonstrating supported
                    templates.
                </>
            ),
        },
    ...
    commands={[
        {
            ...
            description:
                "Verify your project's Custy configuration.",
        },
        {
            title: "Run",
            href: "../run/overview",
