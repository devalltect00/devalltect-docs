  ...
  commands={[
    {
      ...
      description: "Map command responsibilities to their matching tests.",
    },
    {
      title: "Adding Pipeline Steps",
      href: "./adding-pipeline-steps",
      description: "Test registration, ordering, composition, and execution.",
    },
    {
      title: "Adding Version Strategies",
      href: "./adding-version-strategies",
      description: "Test strategy output and workflow dispatch.",
    },
    {
      title: "Contributing",
      href: "./contributing",
      description: "Use the final review checklist before handoff.",
    },
  ]}
/>
