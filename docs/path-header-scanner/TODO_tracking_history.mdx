...
- The target_directory args for scan command. change from str to multiple str or list of str. So the user can scan multiple dir or folders one time, instead of doing it one by one.
