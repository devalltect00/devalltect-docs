...
description: "Path Header Scanner is a developer utility used to automatically insert, validate, replace, and normalize path headers."
sidebar_position: 6
...
See full structure in [`project-structure.mdx`](../project/project-structure).
