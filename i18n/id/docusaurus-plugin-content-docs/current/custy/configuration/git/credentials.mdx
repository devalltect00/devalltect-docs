...
<CommandHero
  ...
  description="Pertahankan native Git sebagai otoritas dan sediakan external HTTPS token untuk push container secara opsional."
...
<InfoBox variant="warning" title="Jangan pernah menaruh token di TOML">
  Tables ini menjelaskan lokasi pencarian token. Tables ini tidak pernah berisi token
  value. Gunakan `custy configure credentials` untuk secret handling.
</InfoBox>
    ...
    items={[
      {
        ...
        defaultValue: "native",
        description:
          "native menonaktifkan fallback Custy. auto mengizinkan enabled sources setelah normal Git authentication.",
      },
      {
        ...
        defaultValue: "true",
        description:
          "Batasi managed fallback ke container agar local credential-manager session tidak berubah.",
      },
      {
        ...
        description:
          "Cari missing sources secara berurutan. Malformed source yang ada menghasilkan error.",
      },
      {
        ...
        defaultValue: "true",
        description:
          "Izinkan normal username/PAT prompt dari Git saat interactive terminal tersedia dan managed token tidak ditemukan.",
      },
      {
        ...
        defaultValue: "true",
        description:
          "Nonaktifkan terminal prompt ketika tidak dapat dijawab agar CI dan detached container tidak hang.",
      },
    ]}
  />
</Section>
    ...
    items={[
      {
        ...
        type: "Boolean",
        defaultValue: "false",
        description: "Opt-in satu supported provider ke managed fallback.",
      },
      {
        property: "username",
        type: "String",
        ...
        description:
          "Non-secret HTTPS username. Default x-access-token untuk GitHub dan oauth2 untuk GitLab.",
      },
      {
        property: "token_file",
        type: "Path string",
        ...
        description:
          "External filename di credential root atau approved absolute path di luar target project.",
      },
      {
        property: "token_env",
        ...
        description:
          "Variable dibaca hanya saat environment ada di source_order dan provider fallback aktif.",
      },
    ]}
  />
</Section>
    ...
    commands={[
      {
        ...
        href: "../../commands/configure/credentials/overview",
        description: "Gunakan hidden input dan focused provider commands.",
      },
      {
        title: "Docker",
        href: "../../getting-started/docker",
        description:
          "Mount protected file atau berikan environment variable ke container.",
      },
      {
        title: "Push Troubleshooting",
        href: "../../commands/push/troubleshooting",
        description: "Interpretasikan authentication dan remote failures.",
      },
      {
        title: "Git Remotes",
        href: "./remotes",
        description: "Pisahkan authentication policy dari destination selection.",
      },
    ]}
  />
</Section>
