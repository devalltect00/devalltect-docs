      ...
      <div className="container">
        ...
        <div className={styles.grid}>
          ...
          >
            ...
            <p>
              Start exploring the Devalltect
          ...
          <Link
            className={styles.card}
            to="/docs/path-header-scanner"
          >
            <h3>Path Header Scanner</h3>

            <p>
              Path validation, header analysis,
          ...
          >
            ...
            <p>
              ...
              structures, and tooling references.
            </p>
          </Link>
          ...
          >
            ...
            <p>
              ...
              and Git workflow documentation.
            </p>
          </Link>
          ...
          >
            ...
            <p>
              ...
              workflows, and implementation guides.
            </p>
          </Link>
        </div>
      </div>
